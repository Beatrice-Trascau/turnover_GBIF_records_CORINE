...
layer_names <- rbind(forest_tws_names, tws_forest_names)
numbers <- c(1: 24)

# Put into single df
layer_names_df <- data.frame(numbers, layer_names)

# Create table
layer_names_df |>
  kbl(caption = "Table 2: Layer Names for 15km Rasters",
      col.names = c("Number", "Layer Names"),
      align = c("l", "r")) |>
