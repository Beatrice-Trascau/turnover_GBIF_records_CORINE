...
# Fit GLS without interaction
birds_FTWS_beta_jne_model1 <- gls(beta_jne ~ forest_to_tws + forest_no_change + 
                                   delta_recorder_effort + log_recorder_effort +
                                   lc_time_period + temp_change + precip_change,
                                 correlation = corExp(form = ~ x + y | time_numeric),
...
birds_FTWS_beta_jne_model2_interaction <-  gls(beta_jne ~ forest_to_tws * temp_change +
                                                  forest_to_tws * precip_change + 
                                                  forest_no_change +
                                                  delta_recorder_effort + 
                                                  log_recorder_effort + 
...
# Fit GLS without interaction 
all_TWSF_beta_jne_model1 <- gls(beta_jne ~ tws_to_forest + tws_no_change + 
                                  delta_recorder_effort + log_recorder_effort + 
                                  lc_time_period + temp_change + precip_change,
                                correlation = corExp(form = ~ x + y | time_numeric),
...
# Fit GLS with interaction term
all_TWSF_beta_jne_model2_interaction <-  gls(beta_jne ~ tws_to_forest * temp_change +
...
# Fit GLS without interaction
birds_TWSF_beta_jne_model1 <- gls(beta_jne ~ tws_to_forest + tws_no_change + 
                                    delta_recorder_effort + log_recorder_effort +
                                    lc_time_period + temp_change + precip_change,
                                  correlation = corExp(form = ~ x + y | time_numeric),
...
# Fit GLS with interaction
birds_TWSF_beta_jne_model2_interaction <-  gls(beta_jne ~ tws_to_forest * temp_change +
                                                 tws_to_forest * precip_change + 
                                                 tws_no_change +
                                                 delta_recorder_effort + 
                                                 log_recorder_effort + 
...
# Fit GLS without interaction
plants_urban_beta_jne_model1 <- gls(beta_jne ~ all_to_urban + urban_no_change +
                                     delta_recorder_effort + log_recorder_effort + 
                                     lc_time_period + temp_change + precip_change,
                                   correlation = corExp(form = ~ x + y | time_numeric),
...
# Fit GLS with interaction term
plants_urban_beta_jne_model2_interaction <-  gls(beta_jne ~ all_to_urban * temp_change +
                                                   all_to_urban * precip_change + 
                                                   urban_no_change +
                                                  delta_recorder_effort + 
                                                  log_recorder_effort + 
...
birds_urban_beta_jne_model1 <- gls(beta_jne ~ all_to_urban + urban_no_change + 
                                    delta_recorder_effort + log_recorder_effort + 
                                    lc_time_period + temp_change + precip_change,
                                  correlation = corExp(form = ~ x + y | time_numeric),
...
# Fit GLS with interaction
birds_urban_beta_jne_model2_interaction <-  gls(beta_jne ~ all_to_urban * temp_change +
                                                  all_to_urban * precip_change + 
                                                  urban_no_change +
                                                 delta_recorder_effort + 
                                                 log_recorder_effort + 
