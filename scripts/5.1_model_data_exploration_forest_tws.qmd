...
jdi_hist <- ggplot(turnover_forest_tws_15km, aes(x = JDI_manual)) +
...
# Extract residuals
bird_residuals_gls <- residuals(birds_FTWS_model2_gls_interaction, type = "normalized")
...
# Residuals vs fitted
plot(fitted(birds_FTWS_model2_gls_interaction), bird_residuals_gls,
     xlab = "Fitted Values", ylab = "Normalized Residuals",
     main = "Residuals vs Fitted")
abline(h = 0, col = "red", lty = 2)
...
# Residuals vs predictors
plot(plants_model_data$forest_to_tws, bird_residuals_gls,
     xlab = "Forest to TWS", ylab = "Normalized Residuals",
     main = "Residuals vs Forest to TWS")
abline(h = 0, col = "red", lty = 2)

plot(plants_model_data$log_recorder_effort, bird_residuals_gls,
     xlab = "Recorder Effort", ylab = "Normalized Residuals",
     main = "Residuals vs Recorder Effort")
abline(h = 0, col = "red", lty = 2)
```
