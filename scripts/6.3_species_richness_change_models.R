...
# 2. FOREST -> TWS SPECIES RICHNESS CHANGE -------------------------------------
...
richness_forest_tws_15km_plants <- vascular_plants_turnover_with_climate |>
  ...
  # Calculate species richness change
...
any(!is.finite(richness_forest_tws_15km_plants$log_recorder_effort)) #FALSE!

# Fit GLS without interaction
plants_FTWS_richness_model1 <- gls(species_change ~ forest_to_tws_prop + forest_no_change_prop +
                                   ...
                                   data = richness_forest_tws_15km_plants,
                                   method = "REML")

# Save model
save(plants_FTWS_richness_model1,
     file = here("data", "models", "final", "plants_FTWS_richness_model1.RData"))

# Fit GLS with interaction term
plants_FTWS_richness_model2_interaction <- gls(species_change ~ forest_to_tws_prop * temp_change +
...
# Save model
save(plants_FTWS_richness_model2_interaction,
     file = here("data", "models", "exploratory", "plants_FTWS_richness_model2_interaction.RData"))

# Compare models based on AIC
AICtab(plants_FTWS_richness_model1, plants_FTWS_richness_model2_interaction, base = TRUE)

## 2.2. Birds ------------------------------------------------------------------

# Select only Forest -> TWS columns
richness_forest_tws_15km_birds <- birds_turnover_with_climate |>
  select(-c('2000-2006_TWS no change', '2000-2006_TWS to Forest',
            '2000-2006_Urban_no_change', '2000-2006_all_to_urban',
            '2006-2012_TWS no change', '2006-2012_TWS to Forest',
            '2006-2012_Urban_no_change', '2006-2012_all_to_urban',
...
# Fit GLS without interaction
birds_FTWS_richness_model1 <- gls(species_change ~ forest_to_tws_prop + forest_no_change_prop + 
                                    delta_recorder_effort + log_recorder_effort +
                                    lc_time_period + temp_change + precip_change,
                                  correlation = corExp(form = ~ x + y | time_numeric),
                                  data = richness_forest_tws_15km_birds,
                                  method = "REML")

# Save model output
save(birds_FTWS_richness_model1,
     file = here("data", "models", "final", "birds_FTWS_richness_model1.RData"))

# Fit GLS with interaction
birds_FTWS_richness_model2_interaction <- gls(species_change ~ forest_to_tws_prop * temp_change +
                                                forest_to_tws_prop * precip_change + 
                                                forest_no_change_prop +
                                                delta_recorder_effort + 
                                                log_recorder_effort + 
...
# Save model
save(birds_FTWS_richness_model2_interaction,
     file = here("data", "models", "exploratory", "birds_FTWS_richness_model2_interaction.RData"))

# Compare models based on AIC
AICtab(birds_FTWS_richness_model1, birds_FTWS_richness_model2_interaction, base = TRUE)


# 3. TWS -> FOREST SPECIES RICHNESS CHANGE -------------------------------------

## 3.1. Vascular Plants --------------------------------------------------------

# Select only TWS -> Forest columns
richness_tws_forest_15km_plants <- vascular_plants_turnover_with_climate |>
...
# Fit GLS without interaction
plants_TWSF_richness_model1 <- gls(species_change ~ tws_to_forest_prop + tws_no_change_prop +
                                     delta_recorder_effort + log_recorder_effort + 
                                     lc_time_period + temp_change + precip_change,
                                   correlation = corExp(form = ~ x + y | time_numeric),
                                   data = richness_tws_forest_15km_plants,
                                   method = "REML")

# Save model
save(plants_TWSF_richness_model1,
     file = here("data", "models", "final", "plants_TWSF_richness_model1.RData"))

# Fit GLS with interaction term
plants_TWSF_richness_model2_interaction <- gls(species_change ~ tws_to_forest_prop * temp_change +
...
# Save model
save(plants_TWSF_richness_model2_interaction,
     file = here("data", "models", "exploratory", "plants_TWSF_richness_model2_interaction.RData"))

# Compare models based on AIC
AICtab(plants_TWSF_richness_model1, plants_TWSF_richness_model2_interaction, base = TRUE)

## 3.2. Birds ------------------------------------------------------------------

# Select only TWS -> Forest columns
richness_tws_forest_15km_birds <- birds_turnover_with_climate |>
  select(-c('2000-2006_Forest no change', '2000-2006_Forest to TWS',
            '2000-2006_Urban_no_change', '2000-2006_all_to_urban',
            '2006-2012_Forest no change', '2006-2012_Forest to TWS',
            '2006-2012_Urban_no_change', '2006-2012_all_to_urban',
...
# Fit GLS without interaction
birds_TWSF_richness_model1 <- gls(species_change ~ tws_to_forest_prop + tws_no_change_prop + 
                                    delta_recorder_effort + log_recorder_effort +
                                    lc_time_period + temp_change + precip_change,
                                  correlation = corExp(form = ~ x + y | time_numeric),
                                  data = richness_tws_forest_15km_birds,
                                  method = "REML")

# Save model output
save(birds_TWSF_richness_model1,
     file = here("data", "models", "final", "birds_TWSF_richness_model1.RData"))

# Fit GLS with interaction
birds_TWSF_richness_model2_interaction <- gls(species_change ~ tws_to_forest_prop * temp_change +
                                                tws_to_forest_prop * precip_change + 
                                                tws_no_change_prop +
                                                delta_recorder_effort + 
                                                log_recorder_effort + 
...
# Save model
save(birds_TWSF_richness_model2_interaction,
     file = here("data", "models", "exploratory", "birds_TWSF_richness_model2_interaction.RData"))

# Compare models based on AIC
AICtab(birds_TWSF_richness_model1, birds_TWSF_richness_model2_interaction, base = TRUE)


# 4. ALL -> URBAN SPECIES RICHNESS CHANGE --------------------------------------

## 4.1. Vascular Plants --------------------------------------------------------

# Select only All -> Urban columns
richness_all_urban_15km_plants <- vascular_plants_turnover_with_climate |>
  select(-c('2000-2006_Forest no change', '2000-2006_Forest to TWS',
...
# Fit GLS without interaction
plants_urban_richness_model1 <- gls(species_change ~ all_to_urban_prop + urban_no_change_prop +
                                      delta_recorder_effort + log_recorder_effort + 
                                      lc_time_period + temp_change + precip_change,
                                    correlation = corExp(form = ~ x + y | time_numeric),
                                    data = richness_all_urban_15km_plants,
                                    method = "REML")

# Save model 
save(plants_urban_richness_model1,
     file = here("data", "models", "final", "plants_urban_richness_model1.RData"))

# Fit GLS with interaction term
plants_urban_richness_model2_interaction <- gls(species_change ~ all_to_urban_prop * temp_change +
...
# Save model
save(plants_urban_richness_model2_interaction,
     file = here("data", "models", "exploratory", "plants_urban_richness_model2_interaction.RData"))

# Compare models based on AIC
AICtab(plants_urban_richness_model1, plants_urban_richness_model2_interaction, base = TRUE)

## 4.2. Birds ------------------------------------------------------------------

# Select only All -> Urban columns
richness_all_urban_15km_birds <- birds_turnover_with_climate |>
  select(-c('2000-2006_Forest no change', '2000-2006_Forest to TWS',
            '2000-2006_TWS no change', '2000-2006_TWS to Forest',
            '2006-2012_Forest no change', '2006-2012_Forest to TWS',
            '2006-2012_TWS no change', '2006-2012_TWS to Forest',
...
# Fit GLS without interaction
birds_urban_richness_model1 <- gls(species_change ~ all_to_urban_prop + urban_no_change_prop +
                                     delta_recorder_effort + log_recorder_effort + 
                                     lc_time_period + temp_change + precip_change,
                                   correlation = corExp(form = ~ x + y | time_numeric),
                                   data = richness_all_urban_15km_birds,
                                   method = "REML")

# Save model 
save(birds_urban_richness_model1,
     file = here("data", "models", "final", "birds_urban_richness_model1.RData"))

# Fit GLS with interaction term
birds_urban_richness_model2_interaction <- gls(species_change ~ all_to_urban_prop * temp_change +
                                                 all_to_urban_prop * precip_change + 
                                                 urban_no_change_prop +
                                                 delta_recorder_effort + 
                                                 log_recorder_effort + 
...
# Save model
save(birds_urban_richness_model2_interaction,
     file = here("data", "models", "exploratory", "birds_urban_richness_model2_interaction.RData"))

# Compare models based on AIC
AICtab(birds_urban_richness_model1, birds_urban_richness_model2_interaction, base = TRUE)


# 5. LOAD FINAL MODELS FOR VISUALIZATION --------------------------------------

# Load all final models (without interactions)
load(here("data", "models", "final", "plants_FTWS_richness_model1.RData"))
load(here("data", "models", "final", "birds_FTWS_richness_model1.RData"))
load(here("data", "models", "final", "plants_TWSF_richness_model1.RData"))
load(here("data", "models", "final", "birds_TWSF_richness_model1.RData"))
load(here("data", "models", "final", "plants_urban_richness_model1.RData"))
load(here("data", "models", "final", "birds_urban_richness_model1.RData"))


# 6. CREATE COEFFICIENT PLOTS --------------------------------------------------

# Function to create coefficient plots for species richness change models
create_coef_plot_richness <- function(model, transition_type, show_y_axis = TRUE) {
  ...
  # Define consistent ordering for all coefficients (reversed)
  term_order <- c(
  ...
  # Clean term names based on transition type
  if (transition_type == "ftws") {
    coef_df <- coef_df |>
      mutate(term_clean = case_when(
        term == "(Intercept)" ~ "Intercept",
        term == "forest_to_tws_prop" ~ "Forest → TWS",
        term == "forest_no_change_prop" ~ "Forest (no change)",
        term == "delta_recorder_effort" ~ "Δ Recorder effort",
  ...
  # Separate intercept from effects
  intercept_df <- coef_df |>
    filter(term == "(Intercept)") |>
    mutate(effect_type = "Intercept")
...
# Row 1: Forest → TWS
ftws_plants_plot <- create_coef_plot_richness(plants_FTWS_richness_model1, "ftws", show_y_axis = TRUE)
ftws_birds_plot <- create_coef_plot_richness(birds_FTWS_richness_model1, "ftws", show_y_axis = FALSE)

# Row 2: TWS → Forest
twsf_plants_plot <- create_coef_plot_richness(plants_TWSF_richness_model1, "twsf", show_y_axis = TRUE)
twsf_birds_plot <- create_coef_plot_richness(birds_TWSF_richness_model1, "twsf", show_y_axis = FALSE)

# Row 3: All → Urban
urban_plants_plot <- create_coef_plot_richness(plants_urban_richness_model1, "urban", show_y_axis = TRUE)
urban_birds_plot <- create_coef_plot_richness(birds_urban_richness_model1, "urban", show_y_axis = FALSE)

# Extract legend from the effects plot
legend <- get_legend(
  ggplot(data.frame(
    x = c(1, 2, 3),
    y = c(1, 2, 3),
...
col1_header <- wrap_elements(grid::textGrob("Vascular Plants", 
                                            gp = grid::gpar(fontsize = 12, fontface = "bold")))
col2_header <- wrap_elements(grid::textGrob("Birds", 
                                            gp = grid::gpar(fontsize = 12, fontface = "bold")))

# Combine all plots into a 3x2 grid with headers
combined_plot <- (
  (col1_header | col2_header) /
    (ftws_plants_plot | ftws_birds_plot) /
    (twsf_plants_plot | twsf_birds_plot) /
    (urban_plants_plot | urban_birds_plot) /
    legend
) +
...
# Save the plot
ggsave(
  filename = here("figures", "species_richness_change_combined_coefficients.png"),
  plot = combined_plot,
  width = 14,
  height = 16,
  dpi = 600,
...
ggsave(
  filename = here("figures", "species_richness_change_combined_coefficients.pdf"),
  plot = combined_plot,
  width = 14,
  height = 16,
  bg = "white"
