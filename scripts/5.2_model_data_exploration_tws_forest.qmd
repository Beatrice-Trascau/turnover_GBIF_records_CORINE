...
# Extract residuals
bird_residuals_gls <- residuals(birds_TWSF_model2_gls_interaction,
                                 type = "normalized")
...
# Residuals vs fitted
plot(fitted(birds_TWSF_model2_gls_interaction), bird_residuals_gls,
     xlab = "Fitted Values", ylab = "Normalized Residuals",
     main = "Residuals vs Fitted")
abline(h = 0, col = "red", lty = 2)
...
# Residuals vs predictors
plot(plants_model_data$tws_to_forest, bird_residuals_gls,
     xlab = "TWS to Forest", ylab = "Normalized Residuals",
