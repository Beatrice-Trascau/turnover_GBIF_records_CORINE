...
jdi_hist <- ggplot(turnover_tws_forest_15km, aes(x = JDI_manual)) +
...
numeric_vars <- turnover_tws_forest_15km  |>
  select(beta_jtu, beta_jne, beta_jac, tws_to_forest, tws_no_change, 
...
## Plot 1: beta_jtu vs tws_to_forest ----------------------------------------

plot1 <- ggplot(turnover_tws_forest_15km, 
                aes(x = tws_to_forest, y = beta_jtu)) +
...
## Plot 2: beta_jtu vs tws_no_change --------------------------------------

plot2 <- ggplot(turnover_tws_forest_15km, 
                aes(x = tws_no_change, y = beta_jtu)) +
  geom_point(alpha = 0.3, color = point_color, size = 0.8) +
  geom_smooth(color = "red", se = TRUE, linewidth = 1) +
...
plot3 <- ggplot(turnover_tws_forest_15km, 
...
plot4 <- ggplot(turnover_tws_forest_15km, 
...
plot5 <- ggplot(turnover_tws_forest_15km, 
...
plot6 <- ggplot(turnover_tws_forest_15km, 
...
# Load model
load(here("data", "models", "final", "TWSF_turnover_model1.RData"))

# Extract correlation structure parameters
print(TWSF_turnover_model1$modelStruct$corStruct)

# Get range parameter
range_param <- coef(TWSF_turnover_model1$modelStruct$corStruct, unconstrained = FALSE)
```
...
# Extract residuals
residuals_gls <- residuals(TWSF_turnover_model1, type = "normalized")

# Get the model frame to ensure we're using the exact same data
model_data <- getData(TWSF_turnover_model1)

# Basic residual plots
par(mfrow = c(2, 2))

# Residuals vs fitted
plot(fitted(TWSF_turnover_model1), residuals_gls,
...
# Load model
load(here("data", "models", "exploratory", "TWSF_turnover_model2_interaction.RData"))

# Extract correlation structure parameters
print(TWSF_turnover_model2_interaction$modelStruct$corStruct)

# Get range parameter
range_param <- coef(TWSF_turnover_model2_interaction$modelStruct$corStruct, unconstrained = FALSE)
```
...
# Extract residuals
residuals_gls <- residuals(TWSF_turnover_model2_interaction, type = "normalized")

# Get the model frame to ensure we're using the exact same data
model_data <- getData(TWSF_turnover_model2_interaction)

# Basic residual plots
par(mfrow = c(2, 2))

# Residuals vs fitted
plot(fitted(TWSF_turnover_model2_interaction), residuals_gls,
     xlab = "Fitted Values", ylab = "Normalized Residuals",
     main = "Residuals vs Fitted")
abline(h = 0, col = "red", lty = 2)
...
# Jaccard's Dissimilarity Index
plant_jdi_hist <- ggplot(plants_turnover_tws_forest_15km, aes(x = JDI_manual)) +
  geom_histogram(bins = 30, fill = "steelblue", color = "white", alpha = 0.7) +
  facet_wrap(~ lc_time_period) +
  labs(x = "Jaccard Dissimilarity Index",
       y = "Count") +
...
# Load model
load(here("data", "models", "final", "plants_TWSF_model1_gls.RData"))
...
# Load model
load(here("data", "models", "exploratory", "plants_TWSF_model2_gls_interaction.RData"))

# Extract residuals
residuals_gls <- residuals(plants_TWSF_model2_gls_interaction, type = "normalized")

# Get the model frame to ensure we're using the exact same data
model_data <- getData(plants_TWSF_model2_gls_interaction)

# Basic residual plots
par(mfrow = c(2, 2))

# Residuals vs fitted
plot(fitted(plants_TWSF_model2_gls_interaction), residuals_gls,
     xlab = "Fitted Values", ylab = "Normalized Residuals",
     main = "Residuals vs Fitted")
abline(h = 0, col = "red", lty = 2)
...
# Jaccard's Dissimilarity Index
bird_jdi_hist <- ggplot(birds_turnover_tws_forest_15km, aes(x = JDI_manual)) +
  geom_histogram(bins = 30, fill = "steelblue", color = "white", alpha = 0.7) +
  facet_wrap(~ lc_time_period) +
  labs(x = "Jaccard Dissimilarity Index",
       y = "Count") +
...
# Load model
load(here("data", "models", "final", "birds_TWSF_model1_gls.RData"))
...
### Trial 2: Bird GLS with interaction
...
# Load model
load(here("data", "models", "exploratory","birds_TWSF_model2_gls_interaction.RData"))

# Extract residuals
plant_residuals_gls <- residuals(birds_TWSF_model2_gls_interaction,
                                 type = "normalized")

# Get the data actually used in the model
plants_model_data <- getData(birds_TWSF_model2_gls_interaction)

# Basic residual plots
par(mfrow = c(2, 2))

# Residuals vs fitted
plot(fitted(birds_TWSF_model2_gls_interaction), plant_residuals_gls,
     xlab = "Fitted Values", ylab = "Normalized Residuals",
     main = "Residuals vs Fitted")
abline(h = 0, col = "red", lty = 2)
...
# Residuals vs predictors
plot(plants_model_data$tws_to_forest, plant_residuals_gls,
     xlab = "TWS to Forest", ylab = "Normalized Residuals",
